...
class BootFrame(tk.Frame):
    ...
    def __update_btn_press(self):  
        ...
        if "Upgrade" == self.update_btn.get_text():
            ...
            if self.scp_en:
                # "Upgrade" cluster (0xFCE5) -> password: 0x5E70D29B (for STM32)
                self.msg_send_bin( [0xA9, 0x65, 0x0F, 0x00, 0x02, 0x00, 0x00, 0x33, 0x00, 0x01, 0xE5, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x23, 0x9B, 0xD2, 0x70, 0x5E] )
            else:
